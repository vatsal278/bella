...
const SocialMediaButtons = ({ handleTilt }) => {
  ...
  const walletAddress = 'aybntGU52SLmgaSbrg4v1a6FiyMKWEEECgXXKndA4Pr';
        ...
        <>
          <div className="flex flex-col bg-gray-300 rounded-3xl items-center w-max p-3 mb-4">
            ...
            <div className="w-full px-10 mb-2">
              <a href="https://dexscreener.com/solana/aybntgu52slmgasbrg4v1a6fiymkweeecgxxknda4pr" target="_blank" rel="noopener noreferrer" className="mx-2 flex-item">
            ...
            <div className="button-row flex flex-row">
              <a href="https://t.me/bellaonsolanaa" target="_blank" rel="noopener noreferrer" className="mx-2 flex-item">
                <button className="bg-black hover:bg-red-600 text-white font-bold rounded-full py-2 px-4">
                  Telegram
                </button>
              </a>
              <button onClick={copyToClipboard} className="bg-black hover:bg-red-600 text-white font-bold rounded-full py-2 px-4">
                $bella's DNA
              </button>
